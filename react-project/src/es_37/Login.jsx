    ...
    render() {
        return (
             <div>
                ...
                <button style={{ backgroundColor: this.state.password.length <= 8 ? 'red': 'green' }} disabled={this.state.username === '' || this.state.password === ''} onClick={this.props.onLogin}>Login</button>
            </div>
